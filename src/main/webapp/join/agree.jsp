...
<head>
    ...
    <script src="https://kit.fontawesome.com/413e34cf30.js" crossorigin="anonymous"></script>
</head>
<body>
<div class="container">
        ...
        <nav class="navbar navbar-expand navbar-dark bg-dark">
            <ul class="navbar-nav nav-fill w-100">
                ...
                <li class="nav-item">
                    <a href="/join/agree.jsp" class="nav-link active disabled" disabled="">
        ...
        <nav class="mt-3">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <button type="button" disabled class="btn btn-success">실명확인</button>
                </li>
                <li class="breadcrumb-item">
...
Copyright © Kakao Corp. All rights reserved.
        ...
        <div class="card card-body bg-light mt-5 mx-3">   <%--주변 테두리 배경 쓸때 card--%>
    ...
    Copyright © Kakao Corp. All rights reserved.
                ...
                <div class="form-check d-flex justify-content-end mt-3">
                    <div class="form-check d-flex justify-content-end mt-3">
                        ...
                        <label for="agree2" class="form-check-label text-primary">개인정보 수집에 동의합니다.</label>
                    </div>
                </div>
            </form>
        </div>
